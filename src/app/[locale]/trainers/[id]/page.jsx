...
export default function TrainerDetails() {
 ...
 const [imgSrc, setImgSrc] = useState(trainerimage);
  ...
  if (loading) {
    return (
      <section className="relative py-24 mt-[112px] md:mt-[156px] bg-[#070A16] text-white overflow-hidden">
        <BgDecor />
  ...
  return (
    <section className="relative py-14  mt-[112px] md:mt-[156px] bg-[#070A16] text-white overflow-hidden">
      <BgDecor />

...
const imageSrc =
 ...
 && String(course.imageUrl
  ...
  if (loading) {
    return (
      <section className="relative py-24 mt-[112px] md:mt-[157px] bg-[#070A16] text-white">
        <BgDecor />
  ...
  return (
    <section className="relative py-14 mt-[112px] md:mt-[157px] bg-[#070A16] text-white overflow-hidden">
      <BgDecor />

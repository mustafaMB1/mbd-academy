...
export default function ArticleDetails() {
  ...
  return (
    <section
      className="min-h-screen bg-gradient-to-b from-white to-[var(--main-color)]/5 py-20 md:mt-[177px]"
    ...
    >
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="bg-white shadow-xl rounded-3xl overflow-hidden mb-10 transition hover:shadow-2xl duration-300">
          ...
          {/* الهيدر بدون صورة */}
          <div className="bg-[var(--main-color)] text-white p-10 text-center">
          ...
          <div className="p-8 md:p-10">
            ...
            {/* المحتوى الكامل من الـ backend */}
            <div
              className="prose max-w-none prose-p:leading-relaxed prose-h2:text-[var(--main-color)] text-gray-800"
